...
//        Toast.makeText(context0, ""+nData.size(), Toast.LENGTH_SHORT).show();
    ...
    public RecycleViewAdapter.MyHoder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View T;
        T = LayoutInflater.from(parent.getContext()).inflate(ctn.example.user.dvectn2.R.layout.row_data,
                parent, false);
...
//        ImageView imgUser;
        ...
        public MyHoder(View itemView,Context context) {
            ...
            tv_name = itemView.findViewById(ctn.example.user.dvectn2.R.id.TW_row_st);
