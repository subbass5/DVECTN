...
public class FragmentMainStudent extends Fragment {
...
//        tv_name.setText(Da);
        ...
        userType = sharedPreferences.getString(Fragment_login.KEY_member_type,null);
         ...
         fab_test = viewtt.findViewById(R.id.fab_main_menu);
         fab = viewtt.findViewById(R.id.fab_add_working);
         fab1 = viewtt.findViewById(R.id.fab_logout);
         fab2 = viewtt.findViewById(R.id.fab_evaluation);
