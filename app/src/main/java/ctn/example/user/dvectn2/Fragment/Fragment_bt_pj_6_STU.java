...
import ctn.example.user.dvectn2.Retrofit.OnNetworkCallback_PJ_P6;
...
public class Fragment_bt_pj_6_STU extends Fragment implements View.OnClickListener {
    String frg;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.av_bt_pj_6_2,container, false);
        context = getContext();
    ...
    OnNetworkCallback_PJ_P6 onCallbackList = new OnNetworkCallback_PJ_P6() {
        @Override
        public void onResponse(POJO_PJ_P6 getstu) {
