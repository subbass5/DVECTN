...
import ctn.example.user.dvectn2.Retrofit.OnNetworkCallback_PJ_P4;
...
public class Fragment_bt_pj_4_STU extends Fragment implements View.OnClickListener {
    String frg;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.av_bt_pj_4_2,container, false);
        context = getContext();
