...
import ctn.example.user.dvectn2.Retrofit.OnNetworkCallback_PJ_P3;
...
public class Fragment_bt_pj_3_STU extends Fragment implements View.OnClickListener {
    String frg;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.av_bt_pj_3_2,container, false);
        context = getContext();
